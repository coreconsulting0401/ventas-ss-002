...
<div class="section-header">
    <h2>
        <i class="bi bi-coin"></i> Editar Transacción
    </h2>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Editar: <span class="text-warning">{{ $transaccion->name }}</span></h5>
    </div>
    <div class="card-body">
        <form action="{{ route('transacciones.update', $transaccion) }}" method="POST">
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               id="name"
                               name="name"
                               value="{{ old('name', $transaccion->name) }}"
            ...
            <div class="alert alert-info">
                ...
                <strong>Proformas:</strong> {{ $transaccion->proformas_count }} |
                @if($transaccion->created_at)
                    <strong>Creado:</strong> {{ $transaccion->created_at->format('d/m/Y H:i') }}
                @endif
            </div>
            ...
            <div class="d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-success">
                    <i class="bi bi-check-circle"></i> Actualizar Transacción
                </button>
            </div>
        </form>
    </div>
