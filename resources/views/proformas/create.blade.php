                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="transaccion_id" name="transaccion_id">
                                            ...
                                            @foreach($transacciones as $transaccion)
                                                <option value="{{ $transaccion->id }}" {{ old('transaccion_id') == $transaccion->id ? 'selected' : '' }}>
                                                    {{ $transaccion->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="temperatura_id" name="temperatura_id">
                                            ...
                                            @foreach($temperaturas as $temperatura)
                                                <option value="{{ $temperatura->id }}" {{ old('temperatura_id') == $temperatura->id ? 'selected' : '' }}>
                                                    {{ $temperatura->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button"
                                            ...
                                            data-descuento="{{ $producto->descuento->porcentaje ?? 0 }}">
