                                ...
                                <tr id="producto-{{ $productoCount }}">
                                    ...
                                    <td>
                                        ...
                                        <input type="number"
                                               ...
                                               data-max-descuento="{{ $maxDescuento }}"
                                               onchange="validarDescuento({{ $productoCount }})"
                                               placeholder="Máx: {{ $maxDescuento }}%">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="alert alert-info mb-0">
                                            ...
                                            Esta proforma no tiene productos asignados.
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="transaccion_id" name="transaccion_id">
                                            ...
                                            @foreach($transacciones as $transaccion)
                                                <option value="{{ $transaccion->id }}" {{ old('transaccion_id', $proforma->transaccion_id) == $transaccion->id ? 'selected' : '' }}>{{ $transaccion->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="temperatura_id" name="temperatura_id">
                                            ...
                                            @foreach($temperaturas as $temperatura)
                                                <option value="{{ $temperatura->id }}" {{ old('temperatura_id', $proforma->temperatura_id) == $temperatura->id ? 'selected' : '' }}>{{ $temperatura->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="estado_id" name="estado_id">
                                            ...
                                            @foreach($estados as $estado)
                                                <option value="{{ $estado->id }}" {{ old('estado_id', $proforma->estado_id) == $estado->id ? 'selected' : '' }}>{{ $estado->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    document.getElementById('formProforma').addEventListener('submit', function(e) {
        if (productosSeleccionados.length === 0) {
            e.preventDefault();
            alert('Debe haber al menos un producto en la proforma');
            return false;
        }
