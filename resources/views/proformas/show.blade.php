...
<div class="section-header">
    <h2>
        <i class="bi bi-file-earmark-text"></i> Detalle de Proforma
    </h2>
    <div class="btn-group">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg" value="S/. {{ number_format($proforma->sub_total, 2) }}" readonly>
                </div>
                <div class="mb-3">
                    <label class="form-label">IGV (18%)</label>
                    <input type="text" class="form-control form-control-lg" value="S/. {{ number_format($proforma->monto_igv, 2) }}" readonly>
                </div>
                <div class="mb-3">
                    <label class="form-label fw-bold">TOTAL</label>
                    <input type="text" class="form-control form-control-lg fw-bold fs-3 text-success" value="S/. {{ number_format($proforma->total, 2) }}" readonly>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card shadow-sm mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="bi bi-cart-check"></i> Productos en la Proforma</h5>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tfoot>
                                <tr class="table-primary">
                                    ...
                                    <th class="fw-bold fs-5">S/. {{ number_format($proforma->total, 2) }}</th>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
