...
<div class="card">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-primary">
                                <i class="bi bi-tag-fill"></i> {{ $categoria->name }}
                            </span>
                        </td>
                        <td>
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col-md-6">
                <p class="mb-0">Total: <strong>{{ $categorias->total() }}</strong> categorías</p>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const tableRows = document.querySelectorAll('#categoriasTable tr');
